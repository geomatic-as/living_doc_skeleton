...
> **Starter template.** Copy this folder to add a new product. Rename it, then fill in the sections below.
...
Why does this matter operationally or commercially?
...
- Service, app, worker, frontend, integration, database, or batch process
...
| `diagrams/` | Exported images and source files |
| `meeting-notes/` | Discussions, syncs, design reviews |
| `roadmap/` | Upcoming work, milestones, dependencies |
| `incidents/` | Postmortems and near-misses |
| `misc/` | Holding pen — move out when a home appears |
...
- Orientation value over completeness.
